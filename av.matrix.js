...
(function(){
	...
	Matrix = function(e) {
		...
		_m.minor = function(i,j){
			if (this.size().some(function(a){a<2})) {console.error("Matrix:submatrix: vectors don't have submatrices");return Matrix();}
			var	_size = this.size,
		...
		_m.samesize = function(arrB){
			var ad =a.size(), bd = b.size();
			return ad[0]==bd[0] && ad[1]==bd[1];
		};		
		_m.is = function(arrB) {
			if (this === arrB) return true;
			if ((this == null || arrB== null) || !this.samesize(arrB)) return false;
			return this.reduce(function(a,b,c,d){return a && b.reduce(function(e,f,g,h){return e && f == arrB[c][g]},true)},true);
		};
		_m.isNaN = function(){
